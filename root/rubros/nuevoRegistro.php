        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form action="../rubros/formRubro.php" method="POST" class="form-horizontal" role="form">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <label for="rubros" class="control-label">Categoría</label>
					</div>

			<div class="col-sm-10">
				<input type="text" class="form-control" id="categoria" name="categoria" placeholder="Ingrese Categoría Rubro">
			</div>
				</div>
