        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form action="../paises/formUpdate.php" method="POST" class="form-horizontal" role="form">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="name" name="name" placeholder="País" value="<?php echo $fila['name']; ?>">
			</div>
				</div>
